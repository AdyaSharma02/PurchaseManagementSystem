...
<body>
    <div class="container1">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
            ...
            $sql = "DELETE FROM new_purchase_order WHERE POID = $id";
            if ($conn->query($sql) === TRUE) {
                echo '<p class="success-message">Purchase Order deleted successfully.</p>';
            } else {
                echo '<p class="error-message">Error deleting Purchase Order: ' . $conn->error . '</p>';
            }
        } else {
